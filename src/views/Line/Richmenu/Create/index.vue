<script lang="ts">
import actionForms from '@/views/Line/Richmenu/Create/components/form'
import InboxLayout, { toLayoutBoxs } from '@/views/Line/Richmenu/Create/components/InboxLayout.vue'
import LayoutSelectorPopup from '@/views/Line/Richmenu/Create/components/popups/LayoutSelectorPopup.vue'
...
import useInboxCreate, { InboxCreateReq } from '@/service/api/useInboxCreate'
